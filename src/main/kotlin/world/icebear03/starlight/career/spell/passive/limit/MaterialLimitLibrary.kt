package world.icebear03.starlight.career.spell.passive.limit

import org.bukkit.Material
import world.icebear03.starlight.career.spell.entry.architect.DemolitionistSet
import world.icebear03.starlight.career.spell.entry.architect.FortressEngineerSet
import world.icebear03.starlight.career.spell.entry.architect.StructuralEngineerSet
import world.icebear03.starlight.career.spell.entry.architect.TrafficEngineerSet
import world.icebear03.starlight.career.spell.entry.cook.BrewerSet
...
fun Material.limit(type: LimitType): List<Pair<String, Int>> {
    return when (type) {
        PLACE -> MaterialLimitLibrary.placeLimits[this]
        BREAK -> MaterialLimitLibrary.breakLimits[this]
        USE -> MaterialLimitLibrary.useLimits[this]
        CRAFT -> MaterialLimitLibrary.craftLimits[this]
        SINTER -> MaterialLimitLibrary.sinterLimits[this]
        DROP_IF_BREAK -> MaterialLimitLibrary.dropIfBreakLimits[this]
    } ?: listOf()
}