...
object FortressEngineerActive {
    ...
    fun initialize() {
        ...
        "淬炼固化".setDischarge skill@{ id, _ ->
            ...
            "§d顿悟 ${display(id)} §7释放成功，黑曜石墙将会在§e15秒§7后消失"
        }
...
object FortressEngineerPassive {
    ...
    fun event(event: EntityDamageEvent) {
        ...
        val level = entity.career().getSpellLevel("缓冲装置")
        if (level in 0..3)
